...
cat ${GSRDPATH}/${EXCEL_NM}.csv | csvcut -v -e "utf-8-sig" -c 1-${LABEL_CNT}> ${EXCEL_NM}_raw.csv
...
FaultName,NSHM23FaultId,LastUpdate,SCECId,NSHM23RateId,State,SiteName,Longitude,Latitude,DistToCFMFault,CFM7ObjectName,Observation,PrefRate,LowRate,HighRate,RateUnct,RateType,ReptReint,OffsetType,AgeType,NumEvents,RateAge,QbinMin,QbinMax,UCERF3AppB,ShortReference,Links,FullReference
"> sliprate_site_tb.csv 
